...
# main gui used is from https://github.com/clear-code-projects/tkinter-complete/tree/main
# used this as it was free for use to anyone commerical or not and was exactly what was
# required being a expanding scrollable GUI

# Check if file exists if so read file data and write to onboard data
...
class ListFrame(ttk.Frame):
    ...
    # does nothing forgot to add functionality as said above :(
    def delete_preset(self, preset_name):
        print(f"Deleted preset: {preset_name}")

# sets all servo values to zero and sends to arduino
def unselect():
